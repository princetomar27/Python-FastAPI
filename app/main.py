...
@app.post("/createPost/v2",status_code=status.HTTP_201_CREATED,  response_model = schemas.CustomPostResponse)
...
@app.put("/posts/{id}",response_model=schemas.CustomPostResponse)
